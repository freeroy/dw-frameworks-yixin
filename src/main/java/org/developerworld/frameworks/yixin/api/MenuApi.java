...
import org.developerworld.frameworks.yixin.api.dto.Menu;
import org.developerworld.frameworks.yixin.api.dto.MenuType;
...
public class MenuApi {
	...
	private final static String CREATE_MENU_API = "https://api.yixin.im/cgi-bin/menu/create";
	private final static String GET_MENU_API = "https://api.yixin.im/cgi-bin/menu/get";
	private final static String DELETE_MENU_API = "https://api.yixin.im/cgi-bin/menu/delete";
	...
	public static List<Menu> getMenu(String accessToken) throws HttpException,
		...
		if (result.get("button") != null
				&& result.get("button") instanceof Collection) {
			Collection menus = (Collection) result.get("button");
