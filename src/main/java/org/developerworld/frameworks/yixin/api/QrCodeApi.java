...
public class QrCodeApi {
	...
	private final static String CREATE_QR_CODE_API = "https://api.yixin.im/cgi-bin/qrcode/create";
	private final static String GET_QR_CODE_API = "https://api.yixin.im/cgi-bin/qrcode/showqrcode";
